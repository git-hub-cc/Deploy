...
OUTPUT_FILE = 'res.md'
# 允许的文件扩展名 (请使用小写)
ALLOWED_EXTENSIONS = ['.html', '.css', '.js', '.vue', '.rs', '.svg', '.xml', '.json']
# 行数限制
LINE_LIMIT = 1500
# 要排除的目录名
EXCLUDED_DIRS = ['node_modules', '.git', '__pycache__', '.venv', 'venv', 'tmp', 'out', '.vite', '.idea', 'gen', 'target', 'combiner', 'doc', 'CET-4', 'CET-6', 'high', 'lib', 'script']
# 【新增】要排除的特定文件名
EXCLUDED_FILES = ['package-lock.json', 'res.md']
# --- 配置结束 ---
